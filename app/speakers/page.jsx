...
// Hardcoded speaker data using images from /public/speaker
// NOTE: Designation / company / bio are filled in only where you shared real
// details (Abhinav, Ajay, Richpal). For everyone else I've left clear
// placeholders — please swap in the correct title, company and bio; I didn't
// want to guess real job titles for real people.
const speakers = [
  {
    id: 1,
    ...
    company: "Viridis",
    bio: "Add bio",
    image: "/speaker/abhinav.jpg",
  },
  {
    id: 2,
    name: "Ajay Yadav",
    designation: "President",
    company: "Renewable Energy Association of Rajasthan",
    bio: "Add bio",
    image: "/speaker/ajay.jpg",
  },
  {
    id: 3,
    name: "Amod Anand ",
    ...
    company: "Loom Solar",
    bio: "Add bio",
    image: "/speaker/amod.jpg",
  },
  {
    id: 4,
    name: "Ankur Mahendru",
    designation: " Technical & Marketing Director, ",
    company: "Usha Shriram Solar",
    bio: "Add bio",
    image: "/speaker/ankur.png",
  },
  {
    id: 5,
    name: "Anuranjan Shukla",
    designation: "Director",
    company: "Arsiga solar",
    bio: "Add bio",
    image: "/speaker/anuranjan.jpg",
  },
  {
    id: 6,
    name: "Dr. Bhawani Singh Rathore",
    designation:
      "Chief Technical Mentor | Lead BESS & Renewable Energy Consultant",
    company: "Kriti Productions",
    bio: "Add bio",
    image: "/speaker/bhawani.png",
  },
  {
    id: 7,
    name: "Deepak Kumar M. Fulwani",
    designation: "Professor at Department of Electrical Engineering",
    company: "IIT Jodhpur",
    bio: "Add bio",
    image: "/speaker/deepak.jpg",
  },
  {
    id: 8,
    name: "Ishita Gogia",
    designation: " Associate Director",
    company: "Practice Lead - Renewable Energy, Gallagher",
    bio: "Add bio",
    image: "/speaker/ishita.jpg",
  },
  {
    id: 9,
    name: "Jai Verma",
    designation: "CEO",
    company: "PV&G Engineers Pvt Ltd (Deye Distributor)",
    bio: "Add bio",
    image: "/speaker/jaiverma.jpg",
  },
  {
    id: 10,
    name: "Krishn Gopal Ratawa",
    designation: "AVP Sales",
    company: "Ultravibrant Solar Energy Pvt. Ltd.",
    bio: "Add bio",
    image: "/speaker/krishan.jpg",
  },
  {
    id: 11,
    name: "Mohammad Hussain Khan",
    designation: "Assistant General Manager – Sales",
    company: "INA Solar",
    bio: "Add bio",
    image: "/speaker/mohammd.jpg",
  },
  {
    id: 12,
    name: "Nitin Agarwal",
    designation: "CEO",
    company: "Rajasthan Solar Association",
    bio: "Add bio",
    image: "/speaker/nitin.jpg",
  },
  {
    id: 13,
    name: "Onkar Singh Rajpurohit",
    designation: "",
    company:
      "Secretary, Laghu Udhyog Bharati Solar Division.; Consultant, Jodhpur Solar Society; Director - Solar Pulse - Sunorses Energy Pvt Ltd",
    bio: "Add bio",
    image: "/speaker/onkar.jpg",
  },
  {
    id: 14,
    name: "Pankaj Mishra",
    designation: "BD Head",
    company: "NewEnergie Renewables Limited- Mumbai",
    bio: "Add bio",
    image: "/speaker/pankaj.jpg",
  },
  {
    id: 15,
    name: "Pritesh Mathur",
    designation: "President,Jodhpur Solar Society & Founder, ",
    company: " Future Energy",
    bio: "Add bio",
    image: "/speaker/pritesh.jpg",
  },
  {
    id: 16,
    name: "Prodyut Ranjan Chakraborty",
    designation: "Professor at Department of Mechanical Engineering",
    company: "IIT Jodhpur",
    bio: "Add bio",
    image: "/speaker/prodyut.png",
  },
  {
    id: 17,
    name: "Richpal Singh",
    designation: "Renewable Energy Professional, Manager",
    company: "Resolven",
    bio: "Add bio",
    image: "/speaker/richpal.jpg",
  },
  {
    id: 18,
    name: "Saurabh Sethi",
    designation: "Director",
    company: "Oneklick Techno Renewable",
    bio: "Add bio",
    image: "/speaker/saurabh.jpg",
  },
  {
    id: 19,
    name: "Shyam Kishore Shrivastava",
    designation: "Vice President - Business Development (BESS), ",
    company: "Invergy",
    bio: "Add bio",
    image: "/speaker/shyam.jpg",
  },
  {
    id: 20,
    name: "Surendra Gupta",
    designation: "Assistant Manager – ESS",
    company: "Replus",
    bio: "Add bio",
    image: "/speaker/surendra.jpg",
  },
];
...
"
              >
                ...
                <span className="block">of Renewable Energy</span>
              </motion.h1>
  ...
  "
    ...
    "
            ...
            <p className="mx-auto mt-8 max-w-4xl text-lg leading-9 text-white/85 md:text-xl">
              ...
              technical sessions, RE-PAX India brings together government
              officials, CEOs, investors, technology pioneers and sustainability
              experts who share practical insights, market trends and
              future-ready strategies shaping the renewable energy industry.
            </p>
          </div>
      ...
      <section className="pb-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-16 text-center">
            <h2 className="mt-12 text-5xl font-bold relative inline-block">
              Speakers
              <span className="absolute -bottom-3 left-1/2 h-1 w-20 -translate-x-1/2 rounded-full bg-orange-500" />
            </h2>
          </div>
  ...
  "
            ...
            <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-slate-300">
              RE-PAX India features a variety of engaging session formats
              designed to deliver practical knowledge, encourage discussion and
              showcase cutting-edge renewable energy innovations.
            </p>
          </div>
  ...
  "
            >
              <span className="block">Key Areas of Discussion</span>
            ...
            <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-slate-600">
              Our speakers will address the most important topics shaping the
              renewable energy industry today, helping professionals understand
              market trends, innovations and future opportunities.
            </p>
          </div>
  ...
  "
              ...
              <p className="mt-8 text-lg leading-9 text-slate-600">
                Are you an industry expert, policymaker, entrepreneur, innovator
                or researcher with valuable insights to share?
              </p>

              <p className="mt-5 text-lg leading-9 text-slate-600">
                Join RE-PAX India as a speaker and engage with renewable energy
                professionals, investors, government leaders and decision makers
  ...
  "
          >
            ...
            <span className="mt-2 block text-orange-400">At RE-PAX India?</span>
          </h2>
          ...
          <p className="mx-auto mt-8 max-w-3xl text-lg leading-9 text-slate-300">
            ...
            conference committee. Every application is carefully reviewed to
            build a diverse, inspiring and impactful speaker lineup for RE-PAX
            India.
          </p>
        </div>
      </section>
  ...
  "
          >
            ...
            <span className="mt-2 block text-[#174d6d]">Renewable Energy</span>
          </h2>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-5">
            <button className="rounded-3xl bg-[#174d6d] px-8 py-4 font-semibold text-white transition-all duration-300 hover:bg-orange-500">
              Become A Speaker
            </button>

            <button className="rounded-3xl border border-[#174d6d] px-8 py-4 font-semibold text-[#174d6d] transition-all duration-300 hover:bg-[#174d6d] hover:text-white">
              Contact Our Team
            </button>
          </div>
        </div>

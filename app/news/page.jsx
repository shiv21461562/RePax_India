...
>
  ...
  <div className="relative z-10 mx-auto max-w-7xl px-6 text-center">
    ...
    <motion.p
      ...
      "
    >
      Stay informed with the latest fintech trends,
      payment innovations, industry announcements and
      exclusive updates from REPAY Summit 2026.
    </motion.p>
  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mb-16 text-center">
      ...
      <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-600">
        Explore the latest stories, insights and updates shaping
        the future of payments, fintech and digital innovation.
      </p>
    </div>
  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mb-16 text-center">
      ...
      <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-300">
        Explore expert opinions, exclusive interviews, industry trends
        and Renewable Observer's latest coverage from across the
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="rounded-[40px] bg-[#255B7D] p-16 text-center text-white">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg text-slate-200">
              Our newsroom will soon feature breaking industry news,
              expert insights and exclusive event coverage.
            </p>

  ...
  <div className="relative mx-auto max-w-7xl px-6">
    ...
    <div className="mb-14 text-center">
      ...
      <p className="mx-auto mt-4 max-w-2xl text-slate-600">
        Get in touch for sponsorships, registrations, partnerships and event support.
      </p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="overflow-hidden rounded-3xl border border-white/20 bg-white/60 backdrop-blur-xl shadow-xl">
            ...
            <div className="relative h-[400px] w-full bg-slate-100">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.607663252122!2d77.228452!3d28.601529!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce3e9d2b6f8a1%3A0x8e2b8c4a6f5e9d7e!2sIndia%20International%20Centre!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            {/* Travel Info */}
            <div className="grid gap-4 border-t border-slate-200/50 p-6 md:grid-cols-3">
              <div className="flex items-center gap-3 text-sm text-slate-600">
                <div className="rounded-lg bg-slate-100 p-2">✈️</div>
                <span>15 min from IGI Airport</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-slate-600">
                <div className="rounded-lg bg-slate-100 p-2">🚇</div>
                <span>5 min from Khan Market Metro</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-slate-600">
                <div className="rounded-lg bg-slate-100 p-2">🚗</div>

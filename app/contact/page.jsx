...
export default function ContactPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-white to-orange-50">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-[#255B7D] pt-36 pb-32">
        {/* Grid Background */}
        <div
        ...
        <div className="relative mx-auto max-w-6xl px-6 text-center">
          <motion.span
            ...
            className="inline-flex items-center rounded-full border border-white/10 bg-white/10 px-6 py-2 text-xs font-semibold tracking-[0.2em] text-white backdrop-blur-xl"
          >
            LET'S CONNECT
          </motion.span>
          ...
          <motion.h1
            ...
            className="mt-8 text-5xl font-bold leading-none md:text-6xl"
          >
            <span className="block text-white">We're Here to Help You</span>
            <span className="mt-2 block text-orange-400">Be Part of RE-PAX India</span>
          </motion.h1>
          ...
          >
            Whether you're interested in attending the conference, becoming a sponsor, exhibiting your 
            latest innovations, speaking at the event, or nominating your organization for the 
            RE-PAX Leadership Awards — our team is here to assist you.
          </motion.p>
          ...
          >
            <div className="rounded-[28px] border border-white/10 bg-[#1B4A66]/70 p-8 backdrop-blur-xl">
              <h3 className="text-5xl font-bold text-orange-400">500+</h3>
              <p className="mt-2 text-slate-300">Event Attendees</p>
            </div>
            <div className="rounded-[28px] border border-white/10 bg-[#1B4A66]/70 p-8 backdrop-blur-xl">
              <h3 className="text-5xl font-bold text-cyan-400">100+</h3>
              <p className="mt-2 text-slate-300">Exhibitors</p>
            </div>
            <div className="rounded-[28px] border border-white/10 bg-[#1B4A66]/70 p-8 backdrop-blur-xl">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="mb-14 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-slate-600">
              Need assistance with registration, sponsorship, or exhibition? Our team is just a call or email away.
            </p>
          </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="grid items-start gap-8 lg:grid-cols-[1.4fr_1fr]">
            ...
            <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_15px_50px_rgba(15,23,42,0.08)]">
              ...
              <h2 className="mt-4 text-3xl font-bold text-slate-900">Have a Question?</h2>
              <p className="mt-2 text-slate-500">
                Fill out the enquiry form below, and our team will respond as soon as possible.
              </p>
            ...
            <div>
              <div className="sticky top-24">
                ...
                <p className="mt-2 text-slate-500">Quick answers to common queries.</p>
                ...
                <div className="mt-6 space-y-4">
                  {faqs.map((faq, index) => (
                    ...
                    >
                      ...
                      <p className="mt-2 text-sm text-slate-600 pl-6">{faq.a}</p>
                    </motion.div>
                  ))}
                </div>

                <div className="mt-6 rounded-2xl bg-[#255B7D] p-6 text-white text-center">
                  <p className="text-sm font-medium">Still have questions?</p>
                  <p className="text-xs text-slate-300 mt-1">Our team is here to help</p>
                  <button
                    type="button"
                    className="mt-3 rounded-full bg-orange-500 px-6 py-2 text-sm font-semibold text-white transition hover:bg-orange-600"
                  >
                    Contact Our Team
                  </button>
                </div>
      ...
      <section className="relative py-24 bg-white overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-slate-600">
              Our team is here to assist you with every aspect of your RE-PAX journey.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="group rounded-[28px] border border-slate-200 bg-white p-8 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:border-orange-500/30">
              ...
              <h3 className="mt-5 text-xl font-bold text-slate-900">Delegate Registration</h3>
              <p className="mt-2 text-sm text-slate-500">Need help registering for the conference?</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-600">
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-orange-500" /> Delegate Passes</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-orange-500" /> Group Registrations</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-orange-500" /> Corporate Registrations</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-orange-500" /> Payment Support</li>
              </ul>
              <div className="mt-5 flex items-center gap-2 text-orange-500 font-semibold text-sm">
                <Mail className="h-4 w-4" /> delegates@repaxindia.com
              </div>
            </div>
            ...
            <div className="group rounded-[28px] border border-slate-200 bg-white p-8 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:border-orange-500/30">
              ...
              <h3 className="mt-5 text-xl font-bold text-slate-900">Sponsorship Opportunities</h3>
              <p className="mt-2 text-sm text-slate-500">Showcase your brand before India's renewable energy leaders.</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-600">
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-cyan-500" /> Sponsorship Packages</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-cyan-500" /> Branding Opportunities</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-cyan-500" /> Customized Partnerships</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-cyan-500" /> Title Sponsorship</li>
              </ul>
              <div className="mt-5 flex items-center gap-2 text-cyan-500 font-semibold text-sm">
                <Mail className="h-4 w-4" /> sponsors@repaxindia.com
              </div>
            </div>
            ...
            <div className="group rounded-[28px] border border-slate-200 bg-white p-8 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:border-orange-500/30">
              ...
              <h3 className="mt-5 text-xl font-bold text-slate-900">Exhibition Enquiries</h3>
              <p className="mt-2 text-sm text-slate-500">Book your booth and showcase your latest products.</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-600">
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> Booth Selection</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> Floor Plan & Pricing</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> Branding Options</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-500" /> Logistics & Installation</li>
              </ul>
              <div className="mt-5 flex items-center gap-2 text-emerald-500 font-semibold text-sm">
                <Mail className="h-4 w-4" /> exhibitors@repaxindia.com
              </div>
            </div>
            ...
            <div className="group rounded-[28px] border border-slate-200 bg-white p-8 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:border-orange-500/30">
              ...
              <h3 className="mt-5 text-xl font-bold text-slate-900">Speaker Enquiries</h3>
              <p className="mt-2 text-sm text-slate-500">Want to speak at RE-PAX India?</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-600">
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-purple-500" /> Speaker Applications</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-purple-500" /> Presentation Topics</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-purple-500" /> Panel Discussions</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-purple-500" /> Technical Sessions</li>
              </ul>
              <div className="mt-5 flex items-center gap-2 text-purple-500 font-semibold text-sm">
                <Mail className="h-4 w-4" /> speakers@repaxindia.com
              </div>
            </div>
            ...
            <div className="group rounded-[28px] border border-slate-200 bg-white p-8 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:border-orange-500/30">
              ...
              <h3 className="mt-5 text-xl font-bold text-slate-900">Awards Enquiries</h3>
              <p className="mt-2 text-sm text-slate-500">Questions about nominations or award categories?</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-600">
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-amber-500" /> Award Categories</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-amber-500" /> Eligibility & Nomination</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-amber-500" /> Supporting Documents</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-amber-500" /> Jury Information</li>
              </ul>
              <div className="mt-5 flex items-center gap-2 text-amber-500 font-semibold text-sm">
                <Mail className="h-4 w-4" /> awards@repaxindia.com
              </div>
            </div>
            ...
            <div className="group rounded-[28px] border border-slate-200 bg-white p-8 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl hover:border-orange-500/30">
              ...
              <h3 className="mt-5 text-xl font-bold text-slate-900">Media & Press</h3>
              <p className="mt-2 text-sm text-slate-500">Journalists, media organizations, and content partners.</p>
              <ul className="mt-4 space-y-2 text-sm text-slate-600">
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-rose-500" /> Press Accreditation</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-rose-500" /> Media Partnerships</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-rose-500" /> Interviews & Press Releases</li>
                <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-rose-500" /> Photography & Video</li>
              </ul>
              <div className="mt-5 flex items-center gap-2 text-rose-500 font-semibold text-sm">
                <Mail className="h-4 w-4" /> media@repaxindia.com
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="rounded-[32px] bg-[#255B7D] p-10 text-white shadow-xl">
              ...
              <div className="mt-6 space-y-4">
                <div className="flex justify-between border-b border-white/10 pb-3">
                  ...
                  <span className="text-orange-400">09:30 AM – 06:30 PM (IST)</span>
                </div>
                <div className="flex justify-between border-b border-white/10 pb-3">
                  <span>Saturday</span>
                  <span className="text-orange-400">10:00 AM – 02:00 PM (IST)</span>
                </div>
              ...
              <div className="mt-6 rounded-xl bg-white/10 p-4">
                <p className="text-sm text-slate-300">📍 Event Venue: Greater Noida, Uttar Pradesh, India</p>
              </div>
            </div>

            {/* Stay Connected */}
            <div className="rounded-[32px] border border-slate-200 bg-white p-10 shadow-sm">
              <h3 className="text-2xl font-bold text-slate-900">Stay Connected</h3>
              <p className="mt-2 text-slate-500">
                Follow RE-PAX India for the latest event announcements, speaker updates, 
                agenda releases, and renewable energy news.
              </p>
              <div className="mt-8 flex gap-4">
                {[
                  { icon: FaLinkedinIn, color: "bg-[#0A66C2]", label: "LinkedIn" },
                  { icon: FaFacebookF, color: "bg-[#1877F2]", label: "Facebook" },
                  { icon: FaInstagram, color: "bg-[#E4405F]", label: "Instagram" },
              ...
              <div className="mt-6 rounded-xl bg-orange-50 p-4 border border-orange-200">
                <p className="text-sm text-slate-700">
                  <span className="font-semibold text-orange-500">🌐</span> Website: www.repaxindia.com
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-3xl border border-white/20 bg-white/60 backdrop-blur-xl shadow-xl">
            <div className="border-b border-slate-200/50 bg-gradient-to-r from-orange-500/5 to-transparent p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-800">Event Venue</h3>
                  <p className="text-sm text-slate-500">
                    RE-PAX India Leadership Conference & Awards • Greater Noida, Uttar Pradesh
                  </p>
                </div>
              </div>
            </div>

    ...
    <section className="relative py-24 overflow-hidden bg-[#1F567A]">
      ...
      <div className="relative container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <button className="px-8 py-4 rounded-full bg-orange-500 text-white font-semibold hover:bg-orange-600 hover:scale-105 transition-all duration-300 shadow-lg">
            Contact Our Team
          </button>
        </motion.div>
      </div>

...
//   const renderWebsiteCard = (item, index, widthClass) => (
//     <a
//       key={index}
//       href={item.link}
//       target="_blank"
...
//     <>
//       {/* hero */}
//       <section className="relative min-h-0 md:min-h-[100dvh] lg:h-screen overflow-hidden bg-[#020817]">
...
//         {/* Background image + overlay: hidden on mobile (plain dark bg shows instead), visible from md+ exactly as before */}
...
//             priority
//             sizes="100vw"
//             className="object-cover object-[73%_center] lg:object-[72%_center]"
//           />
//         </div>

//         <div className="absolute inset-0 hidden md:block bg-gradient-to-r from-[#020817]/60 via-[#020817]/55 to-transparent" />

//         <div className="relative z-10 md:min-h-[100dvh] lg:min-h-screen">
//           <div className="mx-auto flex max-w-7xl flex-col justify-start overflow-x-hidden px-4 pt-24 sm:pt-28 sm:px-6 md:min-h-[100dvh] md:justify-center md:overflow-x-visible md:px-8 md:pt-0 lg:min-h-screen lg:items-center lg:px-8">
//             <div className="grid w-full grid-cols-1 gap-8 py-10 sm:py-14 md:grid-cols-[0.95fr_1.05fr] md:gap-10 md:py-16 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 lg:py-12">
//               {/* LEFT CONTENT */}
//               <div className="mx-auto min-w-0 max-w-full text-center md:mx-0 md:max-w-[520px] md:pt-10 md:text-left lg:max-w-[620px] lg:pt-16">
//                 <h1 className="mt-4 sm:mt-5 md:mt-6 text-[28px] sm:text-[38px] md:text-[50px] lg:text-[60px] leading-[1.1] lg:leading-[1.05] font-black tracking-tight text-white">
//                   RE-PAX India
//                   <span className="text-orange-400"> 2026</span>
//                 </h1>

//                 <h2 className="mx-auto mt-3 sm:mt-4 max-w-full md:mx-0 md:max-w-[480px] lg:max-w-[560px] text-base sm:text-lg md:text-xl font-bold leading-snug text-white">
//                   India's Premier Renewable Energy Conference, Expo &
//                   <span className="text-orange-400"> Leadership Awards</span>
//                 </h2>

//                 {/* Mobile: only the short tagline shows, so the screen stays clean.
//                     From sm+ the full description comes back exactly as before. */}
//                 <p className="mt-4 text-sm leading-6 text-gray-200 sm:mt-6 sm:text-base sm:leading-7 md:mt-8 lg:text-lg lg:leading-8">
//                   <span className="block mb-3 sm:mb-4 text-orange-300 font-medium">
...
//                 {/* CTA Buttons */}
//                 <div className="mt-6 sm:mt-8 flex flex-row flex-wrap justify-center gap-3 sm:w-full sm:flex-nowrap sm:justify-start sm:gap-4">
//                   <Link
//                     href="/register"
//                     className="group inline-flex items-center justify-center overflow-hidden rounded-full border border-orange-400/40 bg-gradient-to-r from-orange-600 to-amber-500 px-5 py-2.5 text-xs font-semibold text-white transition-all duration-300 hover:-translate-y-1 whitespace-nowrap sm:flex-1 sm:px-8 sm:py-4 sm:text-base"
//                   >
//                     Register Now
//                   </Link>
...
//                   <Link
//                     href="/sponsors"
//                     className="inline-flex items-center justify-center rounded-full border border-white/30 bg-white/10 px-5 py-2.5 text-xs font-semibold text-white backdrop-blur-md transition-all duration-300 hover:bg-white hover:text-[#0f172a] whitespace-nowrap sm:flex-1 sm:px-7 sm:py-4 sm:text-base"
//                   >
//                     Become a Sponsor
//                   </Link>
//                 </div>
...
//               {/* RIGHT CONTENT */}
//               <div className="relative flex h-full w-full min-w-0 flex-col items-center justify-end gap-2 md:items-stretch">
//                 {/* Download Button - hidden on mobile, visible from md+ */}
...
//                 {/* Website Cards - Mobile: auto-sliding marquee (right to left), still clickable */}
//                 <div className="mt-6 w-full min-w-0 overflow-hidden md:hidden">
//                   <div
//                     className="flex w-max gap-2 hero-marquee-track"
//                     style={{ animation: "heroMarquee 16s linear infinite" }}
//                   >
//                     {[...websites, ...websites].map((item, index) =>
//                       renderWebsiteCard(item, `mobile-${index}`, "w-[100px] flex-shrink-0")
//                     )}
//                   </div>
//                   <style jsx>{`
...
//                 {/* Website Cards - Desktop/Tablet: original wrap grid, unchanged */}
//                 <div className="hidden md:mt-6 lg:mt-4 md:flex flex-wrap justify-center items-center gap-2 sm:gap-3 md:mx-0">
//                   {websites.map((item, index) =>
//                     renderWebsiteCard(
//                       item,
//                       index,
//                       "w-[30%] min-w-[92px] sm:w-[18%] sm:min-w-[100px]"
//                     )
//                   )}
//                 </div>
//               </div>
  ...
  return (
    <>
      ...
      <section className="relative min-h-0 md:min-h-[100dvh] lg:h-screen overflow-hidden bg-[#020817]">
        ...
        <div className="relative z-10 md:min-h-[100dvh] lg:min-h-screen">
          <div className="mx-auto flex max-w-7xl flex-col justify-start overflow-x-hidden px-4 pt-14 sm:pt-28 sm:px-6 md:min-h-[100dvh] md:justify-center md:overflow-x-visible md:px-8 md:pt-0 lg:min-h-screen lg:items-center lg:px-8">
            <div className="grid w-full grid-cols-1 gap-8 py-10 sm:py-14 md:grid-cols-[0.95fr_1.05fr] md:gap-10 md:py-16 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 lg:py-12">
              {/* LEFT CONTENT */}
              <div className="mx-auto min-w-0 max-w-full text-center md:mx-0 md:max-w-[520px] md:pt-10 md:text-left lg:max-w-[620px] lg:pt-16">
                <h1 className="mt-2 sm:mt-5 md:mt-6 text-[28px] sm:text-[38px] md:text-[50px] lg:text-[60px] leading-[1.1] lg:leading-[1.05] font-black tracking-tight text-white">
                  RE-PAX India
                  <span className="text-orange-400"> 2026</span>
                </h1>
                ...
                {/* Mobile: Short paragraph - only 2 lines */}
                <p className="mt-4 text-sm leading-6 text-gray-200 sm:mt-6 sm:text-base sm:leading-7 md:mt-8 lg:text-lg lg:leading-8">
                  <span className="block mb-3 sm:mb-4 text-orange-300 font-medium">
                    Empowering Innovation • Driving Collaboration •
                    Accelerating India's Clean Energy Future
                  ...
                  <span className="md:hidden">
                    Join India's most influential gathering of renewable energy
                    leaders, solar manufacturers, and battery storage innovators.
                  </span>
                </p>

                {/* CTA Buttons - Mobile: Center aligned with gap, reduced width */}
                <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-5 sm:w-full sm:flex-nowrap sm:justify-start sm:gap-4">
                  <Link
                    href="/register"
                    className="group inline-flex items-center justify-center overflow-hidden rounded-full border border-orange-400/40 bg-gradient-to-r from-orange-600 to-amber-500 px-6 py-3 text-xs font-semibold text-white transition-all duration-300 hover:-translate-y-1 whitespace-nowrap sm:flex-1 sm:px-8 sm:py-4 sm:text-base w-[160px] sm:w-auto"
                  >
                    Register Now
                  </Link>
                  ...
                  <Link
                    href="/sponsors"
                    className="inline-flex items-center justify-center rounded-full border border-white/30 bg-white/10 px-6 py-2.5 text-xs font-semibold text-white backdrop-blur-md transition-all duration-300 hover:bg-white hover:text-[#0f172a] whitespace-nowrap sm:flex-1 sm:px-7 sm:py-4 sm:text-base w-[160px] sm:w-auto"
                  >
                    Become a Sponsor
                  </Link>
                </div>
              ...
              <div className="relative flex h-full w-full min-w-0 flex-col items-center justify-end gap-2 md:items-stretch">
                ...
                {/* Website Cards - Mobile: auto-sliding marquee (right to left), still clickable */}
                <div className="mt-8 w-full min-w-0 overflow-hidden md:hidden">
                  <div
                    className="flex w-max gap-2 hero-marquee-track"
                    style={{ animation: "heroMarquee 16s linear infinite" }}
                  >

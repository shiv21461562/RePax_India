...
//         <div className="relative z-10 min-h-[100dvh] lg:min-h-screen">
//           <div className="mx-auto flex min-h-[100dvh] max-w-7xl flex-col justify-center px-4 sm:px-6 md:px-8 lg:min-h-screen lg:items-center lg:px-8">
//             <div className="grid w-full gap-8 py-8 sm:py-24 md:grid-cols-[0.95fr_1.05fr] md:gap-10 md:py-16 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 lg:py-12">
//               {/* LEFT CONTENT */}
//               <div className="max-w-full md:max-w-[520px] lg:max-w-[620px] md:pt-10 lg:pt-16">
//                 <h1
//                   className="
//                     mt-0 sm:mt-5 md:mt-6
//                     text-[28px]
//                     sm:text-[44px]
//                     md:text-[50px]
//                     lg:text-[60px]
...
//                 <h2 className="mt-0 sm:mt-4 max-w-full md:max-w-[480px] lg:max-w-[560px] text-sm sm:text-lg md:text-xl font-bold leading-snug text-white">
//                   India's Premier Renewable Energy Conference, Expo &
//                   <span className="text-orange-400"> Leadership Awards</span>
//                 </h2>

//                 <p className="mt-0 text-xs leading-5 text-gray-200 sm:mt-6 sm:text-base sm:leading-7 md:mt-8 lg:text-lg lg:leading-8">
//                   <span className="block text-orange-300 font-medium text-xs sm:text-base">
//                     Empowering Innovation • Driving Collaboration •
//                     Accelerating India's Clean Energy Future
//                   </span>
//                   Join India's most influential gathering of renewable energy
...
//                 {/* CTA Buttons */}
//                 <div className="mt-12 sm:mt-8 flex flex-row gap-2 sm:gap-4 w-full sm:w-full justify-center">
//                   <Link
//                     href="/register"
//                     className="group flex-[0.7] sm:flex-1 inline-flex items-center justify-center overflow-hidden rounded-full border border-orange-400/40 bg-gradient-to-r from-orange-600 to-amber-500 px-1.5 sm:px-8 py-2.5 sm:py-4 text-xs sm:text-base font-semibold text-white shadow-[0_12px_35px_rgba(249,115,22,0.35)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(249,115,22,0.55)] whitespace-nowrap"
//                   >
//                     Register Now
//                   </Link>
...
//                   <Link
//                     href="/sponsors"
//                     className="flex-[0.7] sm:flex-1 inline-flex items-center justify-center rounded-full border border-white/30 bg-white/10 px-1.5 sm:px-7 py-2.5 sm:py-4 text-xs sm:text-base font-semibold text-white backdrop-blur-md transition-all duration-300 hover:bg-white hover:text-[#0f172a] whitespace-nowrap"
//                   >
//                     Become a Sponsor
//                   </Link>
//                 </div>
...
//                 {/* Website Cards */}
//                 <div className="mt-8 sm:mt-8 md:mt-6 lg:mt-4 flex flex-wrap justify-center gap-1.5 sm:gap-3">
//                   {websites.map((item, index) => (
//                     <a
//                       key={index}
//                       href={item.link}
...
//                           item.title === "PowerPax India"
//                             ? "h-8 w-12 sm:h-12 sm:w-20 md:h-14 md:w-24"
//                             : "h-5 w-8 sm:h-7 sm:w-12 md:h-8 md:w-14"
//                         }`}
//                       >
//                         <Image
//                           src={item.logo}
...
//                       {/* Title */}
//                       <span className="text-center text-[6px] sm:text-[9px] md:text-[10px] font-normal text-white leading-tight px-0.5">
//                         {item.title}
//                       </span>
